...
from shop.forms import RegistrationForm, LoginForm, UpdateAccountForm, ProductForm
from shop.models import User, Product, Cart, association_table, Order
...
def get_all_products_api():
    ...
    for product in products:
        ...
        product_data['p_name'] = product.p_name
